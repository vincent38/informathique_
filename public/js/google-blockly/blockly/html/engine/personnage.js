...
class Personnage {
    constructor(jsonPersonnage) {
        ...
        if (jsonPersonnage.imageG) {
            this.imgG = new Image();
            this.imgG.src = '../js/google-blockly/blockly/html/resources/images/' + jsonPersonnage.imageG || "";
        }
        if (jsonPersonnage.imageD) {
            this.imgD = new Image();
            this.imgD.src = '../js/google-blockly/blockly/html/resources/images/' + jsonPersonnage.imageD || "";
        }
        if (jsonPersonnage.imageH) {
            this.imgH = new Image();
            this.imgH.src = '../js/google-blockly/blockly/html/resources/images/' + jsonPersonnage.imageH || "";
        }
        if (jsonPersonnage.imageB) {
            this.imgB = new Image();
            this.imgB.src = '../js/google-blockly/blockly/html/resources/images/' + jsonPersonnage.imageB || "";
        }
    ...
    tick() {
        ...
        switch (this.phase) {
            ...
            case 16:
                ...
                break;
            default:
                if(this.phase > 1 && this.phase < 6){
                    this.testerDetectionHeros(this.CVG);
                }else if(this.phase > 6 && this.phase < 11){
                    this.testerDetectionHeros(this.CVH);
                }else if(this.phase > 11 && this.phase < 16){
                    this.testerDetectionHeros(this.CVG);
                }
                this.phase++;
        }
