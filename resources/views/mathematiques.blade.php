...
<div class="container menu">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <a href="{{ route("maths-th1") }}" class="menu-bouton btn btn-success btn-lg">Commencer l'aventure</a>
    ...
    <div class="col-md-6">
      ...
      <a href="{{ route("maths-th2") }}" class="menu-bouton btn btn-success btn-lg">Commencer l'aventure</a>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <a href="{{ route("maths-th3") }}" class="menu-bouton btn btn-success btn-lg">Commencer l'aventure</a>
      <p>Description putain</p>
    </div> <!-- col -->
    <div class="col-md-6">
      <h3>Kini dans la ville de Géométra</h3>
      <a href="/mathematiques-theme-4" class="menu-bouton btn btn-success btn-lg">Commencer l'aventure</a>
      <p>Description putain Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
    </div> <!-- col -->
  </div> <!-- row -->
</div> <!-- container menu -->
...
<div class="container menu">
  ...
  <div class="row">
    <div class="col-md-6">
      <h3>Thème 1</h3>
      <a href="" class="menu-bouton btn btn-success btn-lg">Accéder aux exercices</a>
